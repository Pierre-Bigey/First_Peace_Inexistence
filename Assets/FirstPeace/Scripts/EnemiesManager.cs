...
public class EnemiesManager : MonoBehaviour
{
    ...
    private void CheckEnemyProximity()
    {
        for (int i = 0; i < _supervisedEnemiesList.Count; i++)
        {
            ...
            {   
                AutonomousEnemy autonomousEnemy = _supervisedEnemiesList[i].AddComponent<AutonomousEnemy>();
    ...
    public void RemoveAutomousEnemy(GameObject enemy)
    {
        _autonomousEnemiesList.Remove(enemy);
    }
    
    public void RemoveSupervisedEnemy(GameObject enemy)
    {
